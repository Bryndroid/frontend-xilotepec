  ...
  <main class="container min-vh-100 d-flex align-items-center justify-content-center">
    <div class="card border-0 shadow-sm text-center p-4 p-md-5" style="max-width: 520px;">
      <div class="card-body">
        ...
        <h2 class="fw-bold mb-3">No autorizado</h2>

        <p class="text-muted mb-4">
          Tu sesión no es válida, ha expirado o necesitas iniciar sesión para acceder a esta página.
        </p>

        <a href="<?= $assetBase ?>public/login.php" class="btn btn-primary">
          Iniciar sesión
        </a>

        <a href="<?= $assetBase ?>public/index.php" class="btn btn-outline-secondary ms-2">
          Regresar al inicio
        </a>
