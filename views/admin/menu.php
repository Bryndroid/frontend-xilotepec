                ...
                <div class="bg-white border rounded-3 p-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        ...
                        <div class="position-relative" style="width: 300px;">
                            ...
                            <input type="text" id="input-search-menu" class="form-control ps-5 rounded-pill"
                                placeholder="Buscar por Id o nombre">
                        </div>
                        <!--los fiiltros-->
                        <div class="d-flex gap-3">
                            <!--TODO: Cargar dinamico estas categorias -->
                            <select id="filter-category" class="form-select rounded-pill bg-light border-0"
                                style="width: 150px;">
                                <option value="Todas">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-lg-4 text-center">
                                <div
                                    ...
                                    <img src="#" alt="Imagen producto" id="modal_prod_img"
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="btn-group w-100" role="group">
                                        <input type="radio" name="prod_estado" id="prod_estado_disponible"
                                            class="btn-check" value="Disponible" checked>
                                        <label for="prod_estado_disponible"
                                            class="btn btn-outline-success btn-sm">Disponible</label>
                                        <input type="radio" name="prod_estado" id="prod_estado_agotado"
                                            class="btn-check" value="Agotado">
                                        <label for="prod_estado_agotado"
                                            class="btn btn-outline-success btn-sm">Agotado</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold small">Descripción:</label>
                                    <textarea id="modal_prod_desc" class="form-control" rows="2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="modal_prod_precio" class="form-control" step="0.01"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class=" mt-5">
                                    ...
                                    <input type="number" id="modal_prod_cantidad" class="form-control" step="1"
                                        required>
                                </div>
                            </div>
