                ...
                <div class="row g-3 mb-4 border p-3 rounded-3">
                        ...
                        <div class="bg-white p-3 border rounded-3 h-100">
                            ...
                            <div id="today-revenue-container" class="h2 mb-0">
                                <div class="placeholder-glow">
                                    <span class="placeholder col-4 d-inline-block bg-info" style="height: 28px;"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="bg-white p-3 border rounded-3 h-100">
                            ...
                            <div id='today-order-inactive' class="h2 mb-0">
                                <div class="placeholder-glow">
                                    <span class="placeholder col-4 d-inline-block bg-info" style="height: 28px;"></span>
                                </div>
                            </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="bg-white border rounded-3 h-100">
                                <div class="p-3 border-bottom d-flex justify-content-between">
                                    <h4 class="mb-0">
                                        <select id='select-type-barchart'
                                            class="form-select-sm border-0 bg-transparent fw-bold">
