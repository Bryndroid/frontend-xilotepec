                ...
                <div class="bg-white border rounded-3 p-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        <div class="position-relative" style="width: 300px;">
                            ...
                            <input type="text" id="input-search-usuarios" class="form-control ps-5 rounded-pill"
                                placeholder="Buscar por Id o nombre">
                        </div>
                        <div class="d-flex gap-3">
                            <select id="filter-rol" class="form-select rounded-pill bg-light border-0"
                                style="width: 160px;">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="mb-3" id='container-contra'>
                                    <div class='input-group'>
                                        ...
                                        <button class="btn btn-outline-secondary" type="button"
                                            id="button-addon1">Mostrar</button>
                                ...
                                <div class="bg-white p-3 rounded-3 border">
                                    ...
                                    <div id="permisos-roles-adicionales">
                                        <p class="text-muted small mb-1"><b>Administrador:</b>Acceso total a todas las
                                            fuciones y a vista de Dashboard</p>
                                        <p class="text-muted small mb-1"><b>Cliente:</b>Usuario con acceso a productos y
                                            creacion de ordenes</p>
                                    </div>
                                    <!--hasta aca-->
                                </div>
                            </div>
