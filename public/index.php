      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex">
            <li class="nav-item">
              <a class="nav-link active text-light" aria-current="page" href="#conocenos">Nuestra Historia</a>
            </li>
            <li class="nav-item">
    ...
    <section class="contenedor">
      ...
      <article class="conocenos">
        ...
        <p>
          ...
          por hoy es un impresionante y bello lago. Nuestra misión es no solo ofrecer una excelente taza de café,
      ...
      <div class="bento2" id="promociones-estaticas">
        <article class="box" style="grid-area: box-1"><img src="../img/6.jpg" alt="Promoción Xilotepec" /></article>
        <article class="box" style="grid-area: box-2"><img src="../img/7.jpg" alt="Promoción Xilotepec" /></article>
        <article class="box" style="grid-area: box-3"><img src="../img/8.jpg" alt="Promoción Xilotepec" /></article>
        <article class="box" style="grid-area: box-4"><img src="../img/9.jpg" alt="Promoción Xilotepec" /></article>
        <article class="box" style="grid-area: box-5"><img src="../img/10.jpg" alt="Promoción Xilotepec" /></article>
      </div>
    </section>
  </main>
